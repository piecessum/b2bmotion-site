            ...
            {posts.map((post) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-2 mb-4 text-xs text-[#52525B]">
                  ...
                  <h2 className="font-heading font-semibold text-lg text-[#F5F5F5] mb-2 group-hover:text-white transition-colors">
                    {post.title}
                  </h2>
