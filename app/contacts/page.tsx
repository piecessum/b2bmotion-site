...
const contacts = [
  {
    icon: Phone,
    label: "Телефон",
    value: "+7 (499) 350-34-36",
    href: "tel:+74993503436",
  },
  {
    icon: Mail,
    label: "Email",
    value: "info@b2bmotion.ru",
    href: "mailto:info@b2bmotion.ru",
  },
  {
    icon: MapPin,
    label: "Адрес",
    value: "Воронеж, ул. 60 Армии, д. 26",
    href: null,
  },
  {
    icon: Clock,
              ...
              <div className="p-8 bg-surface-hover rounded-2xl border border-border-default">
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs text-subtle mb-2">
                        Имя
                      </label>
                      <input
                        type="text"
                        placeholder="Ваше имя"
                        className="w-full px-4 py-3 bg-page-alt border border-border-default rounded-xl text-sm text-heading placeholder:text-dim focus:outline-none focus:border-[#3B82F6]/50 transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block text-xs text-subtle mb-2">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-page-alt border border-border-default rounded-xl text-sm text-heading placeholder:text-dim focus:outline-none focus:border-[#3B82F6]/50 transition-colors resize-none"
                    />
                  </div>
                  <div className="flex items-start gap-3">
                    <input
                      type="checkbox"
                      className="mt-1 w-4 h-4 rounded border-border-default bg-page-alt accent-[#3B82F6]"
                    />
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 bg-gradient-to-r from-[#3B82F6] to-[#7C3AED] text-white font-semibold rounded-full hover:shadow-[0_0_24px_rgba(59,130,246,0.2)] dark:hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] transition-all duration-300"
                  >
                    Отправить заявку
                  </button>
                </form>
