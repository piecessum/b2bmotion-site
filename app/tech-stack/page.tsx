        ...
        <div className="max-w-5xl mx-auto">
          <div className="ts-reveal relative overflow-hidden p-8 sm:p-12 rounded-3xl bg-surface border border-border-default">
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-8 lg:gap-12 items-start">
              ...
              <div>
                <span className="text-[11px] uppercase tracking-[0.18em] text-[#60A5FA] mb-3 block">
                  Российский сервер
                </span>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Дата-центр находится под круглосуточной охраной, видеонаблюдением и оснащён современными системами пожаротушения.",
                  ].map((item) => (
                    <li
                      key={item}
