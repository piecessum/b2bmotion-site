...
const articles = [
  {
    ...
    category: "Настройки",
    image: "https://static.tildacdn.com/tild3738-3430-4433-b437-623532656237/01.png",
  },
  {
    title: "Интеллектуальный поиск",
    description: "Умный поиск по каталогу с подсказками, фильтрацией по характеристикам, автоподбором аналогов и исправлением опечаток.",
    category: "Каталог",
    image: "https://static.tildacdn.com/tild3039-6566-4464-b130-666230653330/02.png",
  },
  {
    ...
    category: "Заказы",
    image: "https://static.tildacdn.com/tild3937-3562-4237-a262-363165366562/03.png",
  },
  {
    ...
    category: "Каталог",
    image: "https://static.tildacdn.com/tild6333-3561-4436-a438-303534623937/04.png",
  },
  {
    ...
    category: "Финансы",
    image: "https://static.tildacdn.com/tild3230-3934-4137-b962-346561383866/05.png",
  },
  {
    title: "Модуль оплаты",
    description: "Подключение платёжных систем, оплата по счёту, кредитные лимиты, постоплата и взаиморасчёты.",
    category: "Финансы",
    image: "https://static.tildacdn.com/tild3030-6366-4563-b663-343434653462/06.png",
  },
  {
    ...
    category: "Заказы",
    image: "https://static.tildacdn.com/tild3436-6638-4135-b433-363265383337/07.png",
  },
  {
    ...
    category: "Финансы",
    image: "https://static.tildacdn.com/tild6436-6535-4262-a263-323164356566/08.png",
  },
  {
    ...
    image: "https://static.tildacdn.com/tild3032-6563-4437-a263-363432393861/09.png",
  },
  {
    title: "Модуль рассылок",
    description: "Email и SMS рассылки, сегментация базы, триггерные письма, шаблоны и аналитика доставки.",
    category: "Коммуникации",
    image: "https://static.tildacdn.com/tild3664-6535-4434-a233-656261333031/10.png",
  },
  {
    ...
    category: "Аналитика",
    image: "https://static.tildacdn.com/tild6337-3438-4135-a530-316537373764/11.png",
  },
  {
    title: "Мобильное приложение",
    description: "Нативное приложение для iOS и Android с каталогом, заказами, push-уведомлениями и оффлайн-режимом.",
    category: "Каталог",
    image: "https://static.tildacdn.com/tild3030-3733-4834-b266-653935613531/12.png",
  },
]
