...
export const dbTables: DbTable[] = [
  ...
  /* ── orders ── */
  {
    ...
    fields: [
      { name: "id", type: "INT(11)", kind: "PK" },
      { name: "external_id", type: "VARCHAR(60)" },
      { name: "merchant_id", type: "INT(11)", kind: "FK", refs: "merchant" },
      { name: "company_id", type: "INT(11)", kind: "FK", refs: "company" },
  ...
  /* ── companies (доп.) ── */
  {
    ...
    fields: [
      ...
      { name: "address", type: "TEXT" },
      { name: "phone", type: "VARCHAR(255)" },
      { name: "phone_hotline", type: "VARCHAR(255)" },
      { name: "inn", type: "VARCHAR(12)" },
      { name: "kpp", type: "VARCHAR(9)" },
      ...
      { name: "bank_cor_account", type: "VARCHAR(255)" },
      { name: "bank_bik", type: "VARCHAR(255)" },
      { name: "director", type: "VARCHAR(255)" },
      { name: "accountant", type: "VARCHAR(255)" },
      { name: "consignor", type: "VARCHAR(255)" },
      { name: "gave_out_product", type: "VARCHAR(255)" },
      { name: "offer_for_legal_entities", type: "TEXT" },
      { name: "offer_for_individuals", type: "TEXT" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "email", type: "VARCHAR(120)" },
      { name: "email_agreed_for_marketing", type: "TINYINT(1)" },
      { name: "email_agreed_updated_at", type: "DATETIME" },
      { name: "firstname", type: "VARCHAR(255)" },
      { name: "middlename", type: "VARCHAR(255)" },
      { name: "lastname", type: "VARCHAR(255)" },
      { name: "group", type: "VARCHAR(64)" },
      { name: "bonus", type: "INT(11)" },
    ],
  },
  {
    name: "company_additional_field",
    domain: "companies",
    fields: [
      { name: "company_id", type: "INT(11)", kind: "FK", refs: "company" },
      { name: "type", type: "ENUM(...)" },
  ...
  },
  {
    ...
    fields: [
      { name: "id", type: "INT(11)", kind: "PK" },
      { name: "external_id", type: "VARCHAR(64)" },
      { name: "name", type: "VARCHAR(255)" },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "external_id", type: "VARCHAR(64)" },
      { name: "name", type: "VARCHAR(255)" },
      { name: "segment_group_id", type: "INT(11)", kind: "FK", refs: "segment_group" },
      { name: "parent_external_id", type: "VARCHAR(64)" },
    ],
  },
  {
    name: "company_segment_relation",
    domain: "companies",
    fields: [
      { name: "company_id", type: "INT(11)", kind: "FK", refs: "company" },
      { name: "segment_id", type: "INT(11)", kind: "FK", refs: "segment" },
    ],
  },
  ...
  /* ── catalog (доп.) ── */
  {
    ...
    fields: [
      { name: "id", type: "INT(11)", kind: "PK" },
      { name: "abbreviation", type: "VARCHAR(60)" },
      { name: "sign", type: "VARCHAR(10)" },
      { name: "is_default", type: "INT(1)" },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "url", type: "VARCHAR(255)" },
      {
        name: "external_link_type_id",
        type: "INT",
        kind: "FK",
        refs: "external_link_type",
      },
    ],
  },
  {
    ...
    fields: [
      { name: "product_id", type: "INT(11)", kind: "FK", refs: "product" },
      { name: "analog_product_id", type: "INT(11)", kind: "FK", refs: "product" },
      { name: "sort", type: "SMALLINT(6)" },
    ],
  },
  {
    ...
    fields: [
      { name: "id", type: "INT(11)", kind: "PK" },
      { name: "name", type: "MEDIUMTEXT" },
      { name: "manufacturer_code", type: "VARCHAR(80)" },
      { name: "manufacturer", type: "VARCHAR(120)" },
      { name: "brand_name", type: "VARCHAR(120)" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "alt_name_of_manufacturer", type: "TEXT" },
      { name: "unit_name", type: "VARCHAR(30)" },
      { name: "multiplicity", type: "DECIMAL(8,4)" },
      { name: "image_url", type: "VARCHAR(255)" },
      { name: "country_code_a3", type: "VARCHAR(255)" },
      { name: "brand_id", type: "INT(11)", kind: "FK", refs: "brand" },
      {
        name: "catalog_section_id",
        type: "INT(11)",
        kind: "FK",
        refs: "catalog_section",
      },
  ...
  {
    name: "document_additional_field",
    domain: "documents",
    fields: [
      { name: "document_id", type: "INT(11)", kind: "FK", refs: "document" },
      { name: "type", type: "ENUM(...)" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "price", type: "DECIMAL(11,2)" },
      { name: "quantity", type: "DECIMAL(11,4)" },
      { name: "amount", type: "DECIMAL(11,2)" },
      { name: "unit_name", type: "VARCHAR(30)" },
      { name: "extra_data", type: "MEDIUMTEXT" },
    ],
  },

  /* ── orders (доп.) ── */
  {
    name: "order_additional_field",
    domain: "orders",
    fields: [
      { name: "order_id", type: "INT(11)", kind: "FK", refs: "order" },
      { name: "type", type: "ENUM(...)" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "user_firstname", type: "VARCHAR(255)" },
      { name: "user_middlename", type: "VARCHAR(255)" },
      { name: "user_lastname", type: "VARCHAR(255)" },
      { name: "user_phone", type: "VARCHAR(16)" },
      { name: "user_email", type: "VARCHAR(120)" },
      { name: "user_ip", type: "VARCHAR(45)" },
      { name: "user_role", type: "VARCHAR(64)" },
      { name: "user_region_name", type: "VARCHAR(120)" },
      { name: "store_ids", type: "VARCHAR(255)" },
  ...
  },
  {
    ...
    fields: [
      { name: "product_id", type: "INT(11)", kind: "FK", refs: "product" },
      { name: "region_id", type: "INT(11)", kind: "FK", refs: "region" },
      { name: "days", type: "INT(8)" },
      { name: "quantity", type: "DECIMAL(11,4)" },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "name", type: "VARCHAR(255)" },
      { name: "address", type: "TEXT" },
      { name: "additional_fields", type: "MEDIUMTEXT" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "mon", type: "TINYINT(1)" },
      { name: "tue", type: "TINYINT(1)" },
      { name: "wed", type: "TINYINT(1)" },
      { name: "thu", type: "TINYINT(1)" },
      { name: "fri", type: "TINYINT(1)" },
      { name: "sat", type: "TINYINT(1)" },
      { name: "sun", type: "TINYINT(1)" },
    ],
  },
  {
    name: "pickup_point",
